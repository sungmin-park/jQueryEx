...
(function() {
  ...
  $.Event.ArrowKeys = ArrowKeys = (_ref = [37, 38, 39, 40], $.Event.LEFT = _ref[0], $.Event.UP = _ref[1], $.Event.RIGHT = _ref[2], $.Event.DOWN = _ref[3], _ref);

  $.Event.prototype.isArrowKey = function() {
    var _ref1;
    return _ref1 = this.which, __indexOf.call(ArrowKeys, _ref1) >= 0;
  };
